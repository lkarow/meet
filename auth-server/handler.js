 ...
 * update the calendar yourself. For more info, check out the SCOPES documentation at this link:
...
const credentials = {
  ...
  redirect_uris: ['https://lkarow.github.io/meet/'],
  javascript_origins: ['https://lkarow.github.io', 'http://localhost:3000'],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  // declare access_token and set as credentials in oAuth2Client
